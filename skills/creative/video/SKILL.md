---
name: video
description: "`make me a video.' Use this for video creation, generation, and production workflows. For video content strategy and what to post, see social-content. For paid video ad creative, see ad-creative.

See also: [`references/opensource-video-generation-apis.md`](references/opensource-video-generation-apis.md) for a guide on selecting and using open-source models via API.
"
metadata:
  version: 1.0.0
---
